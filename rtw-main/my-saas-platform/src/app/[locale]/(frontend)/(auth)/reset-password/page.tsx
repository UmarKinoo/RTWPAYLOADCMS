...
function ResetPasswordForm() {
  ...
  const [userType, setUserType] = useState<'candidate' | 'employer' | undefined>(undefined)
  ...
  useEffect(() => {
    ...
    const typeParam = searchParams.get('type') as 'candidate' | 'employer' | undefined
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await resetPassword(token, email, password, userType)
