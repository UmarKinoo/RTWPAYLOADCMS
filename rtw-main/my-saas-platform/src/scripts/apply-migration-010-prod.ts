...
async function applyMigration010Prod() {
  console.log('\n🚀 Applying migration 010 to PRODUCTION: Add phone_verified to employers...\n')
...
applyMigration010Prod()
  .then(() => {
    console.log('\n🎉 Migration 010 applied to PRODUCTION!')
