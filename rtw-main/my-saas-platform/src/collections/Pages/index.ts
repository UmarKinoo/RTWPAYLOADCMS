...
import { allowOnlyAdmin, allowOnlyAdminOrPublishedForRead } from '../../access/allowOnlyAdmin'
...
export const Pages: CollectionConfig<'pages'> = {
  ...
  access: {
    ...
    read: allowOnlyAdminOrPublishedForRead, // admin: all; blog-editor: none; others: published only
