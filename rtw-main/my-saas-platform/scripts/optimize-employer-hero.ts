/**
 * Optimize Employer Registration Hero Image
 * Converts the employer hero PNG to WebP format under 100KB
 */
...
const INPUT_FILE = 'public/assets/1c9081eb8a1bf7184d09a0304d1ffbda9a8d0678.png'
...
async function optimizeEmployerHero() {
  console.log('🖼️  Optimizing Employer Registration Hero Image')
  console.log('================================')
